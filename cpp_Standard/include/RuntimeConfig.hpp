...
struct ProcessRuntimeConfig {
    ...
    bool run_process_rearr = true;
    bool run_process_fd = true;
...
// Method: Store only Standard parameters whose values may change between runs;
//         fixed array dimensions and catalog indices remain compile-time constants.
// ==========================================
struct LensingRuntimeConfig {
    int astrometry_trivial = 0;
