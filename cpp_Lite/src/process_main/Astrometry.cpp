...
namespace Astrometry {
    ...
    // Method: Segment the supplied image, grow all row buffers dynamically, and
    //         retain every bounded component for matching.
    // ==========================================
    ...
    // Method: Accumulate readable two-column Gaia tiles with dynamic storage, then run
    //         the current matching and 17-digit output workflow once.
    // ==========================================
